...
const data: PsychotherapyServiceData = {
  ...
  credentials: [
    ...
    { label: "Heilpraktiker, beschränkt auf Psychotherapie", detail: "Amtliche Erlaubnis zur Ausübung der Heilkunde auf dem Gebiet der Psychotherapie nach dem Heilpraktikergesetz." },
