      ...
      <section className="section-space">
        <div className="container-shell max-w-4xl space-y-9 text-[15px] leading-[1.75] text-slate-700">
          ...
          <div>
            ...
            <p className="mt-3">
              Wir verwenden Consent Mode v2. <code>analytics_storage</code> ist standardmäßig gewährt. <code>ad_storage</code>, <code>ad_user_data</code> und <code>ad_personalization</code> sind zunächst verweigert und werden erst über „Alle akzeptieren“ für Google-Ads-Konversionsmessung, Google Signals, Anzeigenpersonalisierung und besucherbasierte Zielgruppen gewährt. Die standardmäßige Reichweitenmessung stützen wir auf Art. 6 Abs. 1 lit. f DSGVO; unser Interesse liegt in der Messung und Verbesserung unseres Online-Angebots. Soweit eine Einwilligung erforderlich ist, erfolgt die Verarbeitung auf Grundlage von Art. 6 Abs. 1 lit. a DSGVO in Verbindung mit § 25 Abs. 1 TDDDG. Google Ads, Google Signals und Anzeigenpersonalisierung beruhen auf Ihrer Einwilligung.
            </p>
            <p className="mt-3">
          ...
          <div>
            ...
            <p>
              Analyse-Cookies sind beim ersten Besuch standardmäßig aktiviert, sofern keine frühere Ablehnung gespeichert ist. Cookies und Signale für Google Ads, Google Signals, besucherbasierte Werbezielgruppen und Anzeigenpersonalisierung werden erst nach „Alle akzeptieren“ aktiviert. Cloudflare kann in besonderen Sicherheitsfällen technisch notwendige Cookies verwenden, etwa nach einer Sicherheitsprüfung oder Challenge. Die im Local Storage gespeicherte Auswahl ist erforderlich, um Ihre Entscheidung bei weiteren Seitenaufrufen zu beachten.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mt-3">Eine Verarbeitung für Google-Ads-Konversionsmessung, Google Signals, besucherbasierte Zielgruppen und Anzeigenpersonalisierung findet nur nach „Alle akzeptieren“ statt. Formularinhalte und freiwillig eingegebene Gesundheitsangaben werden nicht an Google Analytics oder Google Ads übermittelt.</p>
          </div>
